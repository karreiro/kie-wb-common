 ...
 */
package org.kie.workbench.common.dmn.webapp.common.client.feel; // TODO changed the package
 ...
 */
public class CodeCompletionCore1 {

    public final static Logger logger = Logger.getLogger(CodeCompletionCore1.class.getName());
...
//    private final CandidatesCollection candidates = new CandidatesCollection(); // The collected candidates (rules and tokens).
    ...
    public CodeCompletionCore1(Parser parser, Set<Integer> preferredRules, Set<Integer> ignoredTokens) {
        this.parser = parser;
