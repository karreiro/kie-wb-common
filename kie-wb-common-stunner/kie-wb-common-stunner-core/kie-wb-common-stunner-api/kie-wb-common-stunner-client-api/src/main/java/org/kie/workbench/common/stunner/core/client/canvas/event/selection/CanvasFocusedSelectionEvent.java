...
public class CanvasFocusedSelectionEvent extends AbstractCanvasHandlerEvent<CanvasHandler> {

    private final Collection<String> identifiers;
    private double shapeX;
    private double shapeY;

    public CanvasFocusedSelectionEvent(final CanvasHandler canvasHandler,
    ...
    public void setShapeX(final double shapeX) {
        this.shapeX = shapeX;
    }

    public void setShapeY(final double shapeY) {
        this.shapeY = shapeY;
    }
