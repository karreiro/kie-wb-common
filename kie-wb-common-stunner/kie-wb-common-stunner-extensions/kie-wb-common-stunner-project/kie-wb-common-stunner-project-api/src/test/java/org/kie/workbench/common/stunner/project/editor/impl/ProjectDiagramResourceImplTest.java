...
public class ProjectDiagramResourceImplTest {
    ...
    @Test
    public void testEqualsWhenDiagramXmlIsDifferent() {
    ...
    public void testEqualsWhenTypeIsDifferent() {
        ...
        final ProjectDiagramResourceImpl projectDiagramResource1 = new ProjectDiagramResourceImpl(null, null, DIAGRAM);
        final ProjectDiagramResourceImpl projectDiagramResource2 = new ProjectDiagramResourceImpl(null, null, XML);
