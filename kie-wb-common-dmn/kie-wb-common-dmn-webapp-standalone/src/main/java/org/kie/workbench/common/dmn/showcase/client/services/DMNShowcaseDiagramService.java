...
public class DMNShowcaseDiagramService {
    ...
    public void switchToDMNDiagramElement(final @Observes SelectedDMNDiagramElement changeDiagramEvent) {

        final DMNDiagramElement dmnDiagramElement = changeDiagramEvent.getDiagramElement();
        ...
        if (belongsToCurrentSessionState && getOnLoadDiagramCallback().isPresent()) {
            ...
            DomGlobal.console.log(" DEBUG 201920 ----------->>> " + metadata.getPath().toURI());
        }
    }
