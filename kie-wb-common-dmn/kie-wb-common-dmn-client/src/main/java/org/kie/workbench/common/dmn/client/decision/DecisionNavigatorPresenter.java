...
public class DecisionNavigatorPresenter {
    ...
    void setupView() {
        ...
        view.setupDecisionComponents(getDecisionComponents().getView());
    }

    private DecisionComponents getDecisionComponents() {
    ...
    public void refreshComponentsView() {
        ofNullable(this.handler).ifPresent(handler -> decisionComponents.refresh(handler.getDiagram()));
    }
