...
public class DataTypeList {
    ...
    void setup() {
        ...
        dndListComponent.setOnDropItem(dndDataTypesHandler::onDropDataType);
    }
    ...
    void refreshItemsByUpdatedDataTypes(final List<DataType> updateDataTypes) {
        ...
        getDndListComponent().consolidateHierarchicalLevel2();
        getDndListComponent().refreshItemsPosition();
        searchBar.refresh();
    }
    ...
    void addDataType() {
        ...
        getDndListComponent().refreshItemsPositionAndHTML();
    }
    ...
    void insertBelow(final DataType dataType,
        ...
        refreshItemsByUpdatedDataTypes(Collections.singletonList(listItem.getDataType()));
    }
    ...
    void refreshDNDPosition() {
        dndListComponent.refreshItemsPositionAndHTML();
    }
