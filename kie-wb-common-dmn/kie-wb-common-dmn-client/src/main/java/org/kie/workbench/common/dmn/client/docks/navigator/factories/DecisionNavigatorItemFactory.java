...
public class DecisionNavigatorItemFactory {
    ...
    private final Event<SelectedDMNDiagramElement> selectedDiagramElementEvent;

    private final DMNDiagramsSession dmnDiagramsSession;

    @Inject
    public DecisionNavigatorItemFactory(final DecisionNavigatorBaseItemFactory baseItemFactory,
                                        final Event<SelectedDMNDiagramElement> selectedDiagramElementEvent,
                                        final DMNDiagramsSession dmnDiagramsSession) {
        this.baseItemFactory = baseItemFactory;
        this.selectedDiagramElementEvent = selectedDiagramElementEvent;
    ...
    public DecisionNavigatorItem makeRoot(final DMNDiagramTuple diagramTuple) {
        ...
        return navigatorItemBuilder()
                ...
                .withIsDRG(isDRG)
                .withOnClick(() -> {
                    selectedDiagramElementEvent.fire(new SelectedDMNDiagramElement(dmnDiagramElement));
                })
                .withOnUpdate((item) -> {
                ...
                .withOnRemove((item) -> {
                    ...
                    selectedDiagramElementEvent.fire(new SelectedDMNDiagramElement(dmnDiagramsSession.getDRGDMNDiagramElement()));
                })
                .build();
    }
