...
public class DMNIncludeModelsClient {
    ...
    private <T> ErrorCallback<Boolean> onError(final Consumer<List<T>> listConsumer) {
    ...
    private <T> RemoteCallback<List<T>> onSuccess(final Consumer<List<T>> listConsumer) {
