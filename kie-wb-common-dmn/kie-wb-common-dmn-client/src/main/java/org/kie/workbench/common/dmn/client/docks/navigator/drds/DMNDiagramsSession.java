...
public class DMNDiagramsSession {
    ...
    public void setState(final Metadata metadata,
    ...
    public DMNDiagramsSessionState getSessionState() {
        final String currentSessionKey = getCurrentSessionKey();
        DomGlobal.console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> " + currentSessionKey);
        return dmnSessionStatesByPathURI.get(currentSessionKey);
    }

    public String getCurrentSessionKey() {
        final Diagram diagram = dmnGraphUtils.getDiagram();
    ...
    public void setCurrentDMNDiagramElement(final @Observes SelectedDMNDiagramElement selectedDMNDiagramElement) {
        final DMNDiagramElement selectedDiagramElement = selectedDMNDiagramElement.getDiagramElement();
