...
//                    final Node requiredNode = getNode(dmnEdge.get(), entriesById, reqInputID);
        ...
        if (Objects.nonNull(jsiDMNElementReference)) {
            ...
            final Optional<JSIDMNEdge> dmnEdge = edges.stream()
                    .filter(e -> {
                        ...
                        DomGlobal.console.log("[DEBUG 29812] --------------------------------" + id + "----" + localPart);
            ...
            final Edge myEdge = factoryManager.newElement(diagramId + "#" + id,
                                                          connectorTypeId).asEdge();
            final ViewConnector connectionContent = (ViewConnector) myEdge.getContent();

            DomGlobal.console.log("[DEBUG 90218] --------------------------------");
            DomGlobal.console.log("[DEBUG 90218]        stunner: ", myEdge.getUUID());
            DomGlobal.console.log("[DEBUG 90218]            ref: ", obj.getDmnElementRef().getLocalPart());
            DomGlobal.console.log("[DEBUG 90218]             id: ", obj.getId());
            DomGlobal.console.log("[DEBUG 90218] stunner object: ", myEdge);
            DomGlobal.console.log("[DEBUG 90218] --------------------------------");
...
//    private Node getRequiredNode(final JSIDMNEdge jsidmnEdge,
//                                 final Map<String, List<NodeEntry>> entriesById,
//                                 final String reqInputID) {
//
//        final List<NodeEntry> nodeEntries = getNode(jsidmnEdge, entriesById.entrySet());
//
//        if (entriesById.containsKey(reqInputID)) {
//            final List<NodeEntry> nodeEntry = nodeEntries;
