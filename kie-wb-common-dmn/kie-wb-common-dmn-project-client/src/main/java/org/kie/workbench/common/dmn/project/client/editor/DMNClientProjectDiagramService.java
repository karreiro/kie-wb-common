...
public class DMNClientProjectDiagramService extends ClientProjectDiagramService {
    ...
    @Inject
    public DMNClientProjectDiagramService(final Caller<DMNContentService> dmnContentServiceCaller,
    ...
    public void getByPath(final Path path,
        ...
        dmnContentServiceCaller.call((RemoteCallback<DMNContentResource>) resource -> {
            dmnMarshallerService.unmarshall(resource.getMetadata(), resource.getContent(), new ServiceCallback<Diagram>() {
                @Override
                public void onSuccess(final Diagram diagram) {
                    callback.onSuccess((ProjectDiagram) diagram);
                }
        ...
        dmnMarshallerService.marshall(diagram, new ServiceCallback<String>() {
            ...
            public void onSuccess(final String xml) {
                DMNClientProjectDiagramService
                        .super.saveAsXml(path, xml, metadata, comment, onSaveAsXmlComplete(diagram, callback));
            }
